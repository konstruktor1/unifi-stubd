...
UXG-Pro firmware mcad
  ...
  -> inform-mitm at 172.31.244.12
  -> http://unifi-controller:8080/inform
  -> UniFi Network Application at 172.31.244.10
```
...
```text
lab/gateway-profiles/uxgpro/captures/events.jsonl
```

Committed sanitized telegram samples:

```text
lab/gateway-profiles/uxgpro/fixtures/inform-telegrams.jsonl
```

Committed decoded gateway payload sample:

```text
lab/gateway-profiles/uxgpro/fixtures/decoded-gateway-inform-sample.json
```
...
| Packet version | `0` |
| Payload version | `1` |
| Device MAC in packet header | `02:15:6d:de:ad:00` |
| Device MAC in decoded payload | `02:15:6d:de:ad:00` |
| Device serial in decoded payload | `02156DDEAD00` |
...
system metadata. Setting both `serial` and `serialno` to `02156DDEAD00` made
...
| Field | Observed value |
| --- | --- |
| Device MAC | `02:15:6d:de:ad:00` |
| Device serial | `02156DDEAD00` |
...
```text
lab/gateway-profiles/uxgpro/fixtures/adopted-system-config-summary.json
```
...
| --- | --- | --- | --- |
| `eth0` | `172.31.244.20/24` | `02:15:6d:de:ad:00` | `if_table`, `network_table` |
| `eth1` | `192.0.2.2/24` | `02:15:6d:de:ad:01` | `if_table`, `network_table` |
| `eth2` | `198.51.100.2/24` | `02:15:6d:de:ad:02` | `network_table` |
| `eth3` | `203.0.113.2/24` | `02:15:6d:de:ad:03` | `network_table` |
