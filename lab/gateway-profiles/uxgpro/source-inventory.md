...
| Path | Purpose |
| --- | --- |
| `ubnthal_redirect.c` | LD_PRELOAD shim used to redirect selected firmware reads from `/proc/ubnthal` and `/proc/sys` into mock files during isolated Docker simulation. |
