...
| [OPNsense API Reference](https://docs.opnsense.org/development/api.html), [OPNsense API how-to](https://docs.opnsense.org/development/how-tos/api.html), and [OPNsense Interfaces API](https://docs.opnsense.org/development/api/core/interfaces.html) | Deciso / OPNsense | API path shape, GET-only read semantics, key/secret Basic Auth, and interface overview endpoints | Read-only OPNsense companion generator endpoint selection and docs | Official documentation |
