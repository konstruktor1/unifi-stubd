// Package device reads route and Linux sysfs speed data for status payloads.
// Link detection reports plausible uplink metadata without creating interfaces,
// assigning addresses, or changing routes.
package device
