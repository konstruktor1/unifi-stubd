// Inform sending selects the adoption key and packet cipher for each heartbeat.
// AES-GCM attempts and CBC fallback are recorded so logs and status can explain
// the actual controller exchange.
package main
