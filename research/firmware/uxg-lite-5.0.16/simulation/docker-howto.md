...
```sh
RESEARCH=research/firmware/uxg-lite-5.0.16
...
cp research/firmware/uxgpro-5.0.16/simulation/ubnthal_redirect.c \
...
serial=00156D00A677
hwaddrbbase=00:15:6d:00:a6:77
hwaddrbase=00:15:6d:00:a6:77
```
...
shortname=UXG
boardrevision=1
serialno=00156D00A677
manufid=003d
mfgweek=202607
qrid=SIMULATED
cpu_rev_id=00010000
macaddr=00:15:6d:00:a6:77
eth0.macaddr=00:15:6d:00:a6:77
eth1.macaddr=00:15:6d:00:a6:78
firmware=5.0.16
```
...
```sh
docker compose -f "$RESEARCH/simulation/compose.yaml" ps
docker compose -f "$RESEARCH/simulation/compose.yaml" logs --tail 120 firmware
```
...
```sh
docker compose -f "$RESEARCH/simulation/compose.yaml" exec firmware \
